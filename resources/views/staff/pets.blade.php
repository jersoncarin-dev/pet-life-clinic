        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2 text-center text-sm-left">
            <div class="flex-sm-fill">
                ...
                <h2 class="h6 font-w500 text-muted mb-0">
                    Welcome <a class="font-w600" href="javascript:void(0)">{{ strtok(trim(auth()->user()->name),' ') }}</a>, you may view all client pets.
                </h2>
            </div>
        </div>
    </div>
...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Client Pets</h3>
                    ...
                    <tbody>
                        @foreach($pets as $pet)
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted text-center">{{ $pet->owner->name }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
